...
class RpcProviderEndpointPromiseTests: XCTestCase {
    ...
    func testGetInfo(unhappy: Bool = false) {
        ...
        firstly {
            ...
            print($0)
            if unhappy {
                XCTAssertTrue($0.arisenError.errorCode == ArisenErrorCode.rpcProviderError)
            } else {
    ...
    func testGetRawAbi(unhappy: Bool = false) {
        ...
        firstly {
            ...
            XCTAssertTrue($0.accountName == "arisen")
    ...
    func testGetRequiredKeys(unhappy: Bool = false) {
        ...
        firstly {
            ...
            XCTAssertTrue($0.requiredKeys[0] == "RSN5j67P1W2RyBXAL8sNzYcDLox3yLpxyrxgkYy1xsXzVCvzbYpba")
        }.catch {
            print($0)
            if unhappy {
                XCTAssertTrue($0.arisenError.errorCode == ArisenErrorCode.rpcProviderError)
    ...
    func testGetAccount(unhappy: Bool = false) {
        ...
        firstly {
            ...
            let arisenRpcAccountResponse = $0
            ...
            XCTAssert(keysAndWeight.key == "RSN5j67P1W2RyBXAL8sNzYcDLox3yLpxyrxgkYy1xsXzVCvzbYpba")
    ...
    func testGetCurrencyBalance(unhappy: Bool = false) {
        ...
        firstly {
            ...
            XCTAssert($0.currencyBalance[0].contains(words: "RIX"))
        }.catch {
            print($0)
            if unhappy {
                XCTAssertTrue($0.arisenError.errorCode == ArisenErrorCode.rpcProviderError)
    ...
    /// Test getCurrencyStatsRIX() promise implementation.
    func testGetCurrencyStatsRIX(unhappy: Bool = false) {
        var callCount = 1
        (stub(condition: isHost("localhost")) { request in
    ...
    /// Test getCurrencyStatsRIX promise happy path.
    func testGetCurrencyStatsSuccess() {
        testGetCurrencyStats()
    }

    /// Test getCurrencyStatsRIX promise unhappy path.
    func testGetCurrencyStatsFail() {
        testGetCurrencyStats(unhappy: true)
    }

    /// Test getCurrencyStatsRIX promise happy path.
    func testGetCurrencyStatsSuccessRIX() {
        testGetCurrencyStatsRIX()
    }
    ...
    func testGetRawCodeAndAbi(unhappy: Bool = false) {
        ...
        firstly {
            ...
            XCTAssertNotNil($0._rawResponse)
            XCTAssert($0.accountName == "arisen.token")
        }.catch {
            print($0)
            if unhappy {
                XCTAssertTrue($0.arisenError.errorCode == ArisenErrorCode.rpcProviderError)
    ...
    func testGetRawCodeAndAbiWithStringSignature(unhappy: Bool = false) {
        ...
        firstly {
            (rpcProvider?.getRawCodeAndAbi(.promise, accountName: "arisen.token"))!
        }.done {
            if unhappy {
    ...
    func testGetTableByScope(unhappy: Bool = false) {
        ...
        firstly {
            ...
            XCTAssert($0.more == "arisen.ramfee")
        }.catch {
            print($0)
            if unhappy {
                XCTAssertTrue($0.arisenError.errorCode == ArisenErrorCode.rpcProviderError)
