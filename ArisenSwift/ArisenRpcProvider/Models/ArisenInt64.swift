...
public enum ArisenInt64: Codable {
    /// Value as a `Int64`.
    case int64(Int64)
    /// Value as a `String`.
    case string(String)
    ...
    public init(from decoder: Decoder) throws {
        ...
        do {
            ...
            do {
                ...
                throw DecodingError.typeMismatch(ArisenInt64.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Encoded payload not of an expected type"))
            }
        }
    }
