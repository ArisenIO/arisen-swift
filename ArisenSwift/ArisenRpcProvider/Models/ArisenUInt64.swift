...
public enum ArisenUInt64: Codable {
    /// Value as a `UInt64`.
    case uint64(UInt64)
    /// Value as a `String`.
    case string(String)
    ...
    public init(from decoder: Decoder) throws {
        ...
        do {
            ...
            do {
                ...
                throw DecodingError.typeMismatch(ArisenUInt64.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Encoded payload not of an expected type"))
            }
        }
    }
