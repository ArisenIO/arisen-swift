...
public struct ArisenAccountInfo: Codable {
...
public typealias ArisenRpcAccountRequest = ArisenAccountInfo

/// The request struct for `push_transactions` RPC requests.
public struct ArisenRpcPushTransactionsRequest: Codable {
    public let transactions: [ArisenRpcPushTransactionRequest]
    public init(transactions: [ArisenRpcPushTransactionRequest]) {
        self.transactions = transactions
    }
}

/// The request type for `get_block_header_state` RPC requests.
public typealias ArisenRpcBlockHeaderStateRequest = ArisenRpcBlockRequest

/// The request type for `get_abi` RPC requests.
public typealias ArisenRpcAbiRequest = ArisenAccountInfo

/// The request struct for `get_currency_balance` RPC requests.
public struct ArisenRpcCurrencyBalanceRequest: Codable {
...
public struct ArisenRpcCurrencyStatsRequest: Codable {
    public var code: String
    public var symbol: String
...
public struct ArisenRpcProducersRequest: Codable {
...
public typealias ArisenRpcRawCodeAndAbiRequest = ArisenAccountInfo

/// The request struct for `get_table_by_scope` RPC requests.
public struct ArisenRpcTableByScopeRequest: Codable {
...
public struct ArisenRpcTableRowsRequest: Codable {
...
public struct ArisenRpcCodeRequest: Codable {
...
public struct ArisenRpcHistoryActionsRequest: Codable {
...
public struct ArisenRpcHistoryTransactionRequest: Codable {
...
public struct ArisenRpcHistoryKeyAccountsRequest: Codable {
...
public struct ArisenRpcHistoryControlledAccountsRequest: Codable {
...
public struct ArisenRpcSendTransactionRequest: Codable {
    ...
    /// Initialize an `ArisenRpcSendTransactionRequest`.
