//
//  ArisenTransactionPromises.swift
//  ArisenSwift
//
...
// MARK: - `ArisenTransaction` methods returning Promises.
extension ArisenTransaction {
    ...
    // public func sign(publicKeys: [String], completion: @escaping (ArisenResult<Bool, ArisenError>) -> Void)
